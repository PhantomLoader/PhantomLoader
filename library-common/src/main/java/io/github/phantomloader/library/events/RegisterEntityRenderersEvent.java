...
public interface RegisterEntityRenderersEvent {
     ...
     * </p>
     *
     * @param entity A supplier returning the registered entity type, the one returned by {@link io.github.phantomloader.library.registry.ModRegistry#registerEntity(String, EntityType.Builder)}.
